...
import com.example.moneyloveramateur.activity.AfterLoginActivity;
...
public class AfterLoginAdapter extends RecyclerView.Adapter<AfterLoginAdapter.WalletViewHolder> {
    private Context context;
    private List<Wallet> walletList;

    public AfterLoginAdapter(Context context) {
